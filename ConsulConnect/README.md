...
Use the id to create the Kong Service and Kong Route. Notice that the Kong Service refers to the FQDN of the Kubernetes Service <pre>web-sidecar</pre> previously deployed:
<pre>
